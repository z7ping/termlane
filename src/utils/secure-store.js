...
// It has been replaced by secure-store-browser.js which uses AES-256-GCM encryption.
...
export { secureStore, storePassword, getPassword, removePassword } from './secure-store-browser.js'
