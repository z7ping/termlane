...
const messages = {
  zh: {
    ...
    connection: { name: '名称', host: '主机', port: '端口', username: '用户名', password: '密码', authType: '认证方式', keyPath: '密钥路径', passphrase: '密钥密码', group: '分组', test: '测试连接', save: '保存', cancel: '取消', testing: '测试中...', success: '连接成功', failed: '连接失败', passwordAuth: '密码', keyAuth: 'SSH 密钥', jumpHost: '代理跳板', jumpHostDesc: '通过中间服务器连接' },
    ...
    onboarding: { step1Title: '欢迎使用 XTerminal Pro', step1Desc: '轻量级 SSH 终端工具，基于 Tauri 构建，内存占用仅 30MB。', step2Title: '连接你的服务器', step2Desc: '点击左侧 + 添加 SSH 连接，支持密码和密钥认证。', next: '下一步', prev: '上一步', start: '开始使用 🚀' },
  },
  en: {
    ...
    connection: { name: 'Name', host: 'Host', port: 'Port', username: 'Username', password: 'Password', authType: 'Auth Type', keyPath: 'Key Path', passphrase: 'Passphrase', group: 'Group', test: 'Test Connection', save: 'Save', cancel: 'Cancel', testing: 'Testing...', success: 'Connection successful', failed: 'Connection failed', passwordAuth: 'Password', keyAuth: 'SSH Key', jumpHost: 'Jump Host', jumpHostDesc: 'Connect via intermediate server' },
    ...
    onboarding: { step1Title: 'Welcome to XTerminal Pro', step1Desc: 'Lightweight SSH terminal built with Tauri. Only 30MB memory usage.', step2Title: 'Connect your servers', step2Desc: 'Click + on the left to add SSH connections.', next: 'Next', prev: 'Previous', start: 'Get Started 🚀' },
  },
}
